object qBitMainForm: TqBitMainForm
  Left = 0
  Top = 0
  ...
  object PMMain: TPopupMenu
    ...
    object ITMResume: TMenuItem
      Caption = 'Resume'
      OnClick = ITMResumeClick
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object ITMAdd: TMenuItem
      Caption = 'Add'
      object ITMAddTFile: TMenuItem
        Caption = 'Torrent File'
        OnClick = ITMAddTFileClick
      end
      object ITMAddMagnetURL: TMenuItem
        Caption = 'Magnet URL'
        OnClick = ITMAddMagnetURLClick
      end
    end
    object ITMDelete: TMenuItem
      Caption = 'Delete'
      object ITMDelTOnly: TMenuItem
        Caption = 'Torrents Only'
        OnClick = ITMDelTOnlyClick
      end
      object ITMDelWithData: TMenuItem
        Caption = #9888' With Data '#9888
        OnClick = ITMDelWithDataClick
      end
    end
    object N2: TMenuItem
      Caption = '-'
    end
    object ITMSetLoc: TMenuItem
      Caption = 'Set Location'
      OnClick = ITMSetLocClick
    end
